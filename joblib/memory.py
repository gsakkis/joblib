...
class MemorizedFunc(Logger):
    ...
    def _cached_call(self, args, kwargs, shelving=False):
        ...
        if not (self._check_previous_func_code(stacklevel=4) and
            ...
            if self._verbose > 10:
                ...
                location = self.store_backend.get_cached_func_info(
                    [self.func_id])['location']
        ...
        if shelving:
            return self._get_memorized_result(args_id)
    ...
    def _call(self, path, args, kwargs, shelving):
        ...
        if shelving:
            return self._get_memorized_result(path[1], metadata)
    ...
    def _get_memorized_result(self, args_id, metadata=None):
